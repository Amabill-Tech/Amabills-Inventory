            ...
            <b-card>
              <b-row>
                ...
                <b-col md="6" class="mb-2">
                  <validation-provider
                    ...
                    v-slot="validationContext"
                  >
                    <b-form-group :label="$t('Product Size') + ' ' + '*'">
                      <b-form-input
                        :state="getValidationState(validationContext)"
                        aria-describedby="ProductSize-feedback"
                        label="Size"
                        :placeholder="$t('Enter_Product_size')"
                        v-model="product.size"
                      ></b-form-input>
                      <b-form-invalid-feedback
                        id="ProductSize-feedback"
                      >{{ validationContext.errors[0] }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                </b-col>
              ...
              <b-col md="6" class="mb-2">
                  <validation-provider
                    ...
                    v-slot="validationContext"
                  >
                    <b-form-group :label="$t('Product GSM') + ' ' + '*'">
                      <b-form-input
                        :state="getValidationState(validationContext)"
                        aria-describedby="ProductGSM-feedback"
                        label="GSM"
                        :placeholder="$t('Enter_product_GSM')"
                        v-model="product.gsm"
                      ></b-form-input>
                      <b-form-invalid-feedback
                        id="ProductGSM-feedback"
                      >{{ validationContext.errors[0] }}</b-form-invalid-feedback>
                    </b-form-group>
                  </validation-provider>
                </b-col>
