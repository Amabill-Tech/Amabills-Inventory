              ...
              <table class="table table-bordered table-sm mt-4">
                <tbody>
                  ...
                  <tr>
                    ...
                    <th>
                      <span class="badge badge-outline-success">{{$t('Field_is_required')}}</span>
                      {{$t('size_must_be_not_exist_already')}}
                    </th>
                  </tr>

                  <tr>
                    <td>{{$t('WeightProduct')}}</td>
                    <th>
                      <span class="badge badge-outline-success">{{$t('Field_is_required')}}</span>
                      {{$t('weight_must_be_not_exist_already')}}
                    </th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th>
                      <span class="badge badge-outline-success">{{$t('Field_is_required')}}</span>
                      {{$t('gsm_must_be_not_exist_already')}}
                    </th>
                  </tr>
